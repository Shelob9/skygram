...
export function OAuthSignInForm({
  ...
  return (
    <form {...props} className="max-w-lg w-full" onSubmit={onSubmit}>
      <fieldset className="rounded-md border border-solid">
        <div className="relative p-1 flex flex-wrap items-center justify-stretch">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-blue text-blue-600 rounded-md py-1 px-3 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:ring-inset"
          >
            Login
          </button>
